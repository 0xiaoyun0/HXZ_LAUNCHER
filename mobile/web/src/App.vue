...
const appUpdate=ref({currentVersion:'0.4.5',currentBuild:40503,autoCheck:true,autoDownload:true,phase:'idle'});
...
function readSettings(){
  const defaults={theme:'system',font:15,accent:'#58734b',ptt:false,animations:true,chatHistoryDays:0,layoutRevision:2};
  try{
