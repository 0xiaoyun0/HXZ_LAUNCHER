...
let serial=0;
export const state=reactive({server:'https://qqbot.hxzmc.top',user:{},profiles:[],selectedProfile:null,hasAccount:false,connected:false,connection:'未登录',users:[],messages:[],room:'',muted:false,deafened:false,ptt:false,id:'',version:'0.4.2'});
