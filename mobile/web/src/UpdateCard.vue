...
<template>
  ...
  <div class="card update-card">
    <div class="update-heading"><span class="avatar"><Icon name="download"/></span><div><strong>幻想镇社区 {{state.currentVersion||'0.4.3'}}</strong><small>构建 {{state.currentBuild||40301}}</small></div><span v-if="state.phase==='ready'" class="tag">可安装</span></div>
